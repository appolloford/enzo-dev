...
/*      if (HydroMethod == Zeus_Hydro &&
    ...
    if (use_naunetrenorm) {
      ...
      if (MultiSpecies == NAUNET_SPECIES && NumberOfBaryonFields > 104) {
          ...
          for (j = 0; j < GridDimension[1]; j++) {
            ...
            for (i = 0; i < GridStartIndex[0]; i++) {
              for (int sidx = 0; sidx < NSPECIES; sidx++) {
                ...
                yab[sidx] = BaryonField[snum][fieldindex+i] * NumberDensityUnits / A_Table[sidx];
              }
              ...
              for (int sidx = 0; sidx < NSPECIES; sidx++) {
                int snum = specnum[sidx];
                BaryonField[snum][fieldindex+i] = yab[sidx] * A_Table[sidx] / NumberDensityUnits;
              }
            }
            for (i = GridEndIndex[0]+1; i < GridDimension[0]; i++) {
              for (int sidx = 0; sidx < NSPECIES; sidx++) {
        ...
        for (j = 0; j < GridStartIndex[1]; j++) {
          for (k = 0; k < GridDimension[2]; k++) {
            fieldindex = (k*GridDimension[1] + j)*GridDimension[0];
            for (i = 0; i < GridDimension[0]; i++, fieldindex++) {
              for (int sidx = 0; sidx < NSPECIES; sidx++) {
                int snum = specnum[sidx];
                yab[sidx] = BaryonField[snum][fieldindex] * NumberDensityUnits / A_Table[sidx];
              }
              ...
              for (int sidx = 0; sidx < NSPECIES; sidx++) {
                int snum = specnum[sidx];
                BaryonField[snum][fieldindex] = yab[sidx] * A_Table[sidx] / NumberDensityUnits;
              }
            }
          }
        }
